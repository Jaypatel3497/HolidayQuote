...
import { getEntities } from './customer-my-suffix.reducer';
import { ICustomerMySuffix } from 'app/shared/model/customer-my-suffix.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface ICustomerMySuffixProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export class CustomerMySuffix extends React.Component<ICustomerMySuffixProps> {
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="customer-my-suffix-heading">
          Customers
...
export default connect(mapStateToProps, mapDispatchToProps)(CustomerMySuffix);
