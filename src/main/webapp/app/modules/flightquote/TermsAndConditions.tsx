...
export class TermsAndConditions extends React.Component<IHomeProp> {
  constructor(props) {
    super(props);
  ...
  componentWillMount()
  {
    fetch('http://localhost:8080/api/terms-conditions', {
      method: 'GET',
      headers: {
  ...
  render() {
    return (<div>
            <Typeahead
             ...
             placeholder="Choose a termsconditions."
           />
           <Link to="/cancellation-policy" className="alert-link" onClick={this.handlerNextPage.bind(this)} >
